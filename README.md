...
<!-- HERO --------------------------------------------------------------->
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=800&size=30&pause=1200&center=true&vCenter=true&width=980&lines=Hi%2C+I'm+Kaveesh+Jeffry+Vershan+%F0%9F%91%8B;Flutter+%2B+Spring+Boot+Developer;Software+Engineering+Undergraduate+(CINEC);I+build+scalable+web+%26+mobile+apps" alt="Typing header" />
</p>
...
- 🏷️ **Currently**: Building a multi-app **WE** ecosystem (Client / Driver / Vendor) with SSE live tracking & notifications  
- 🎓 **Education**: BSc (Hons) in Software Engineering — **CINEC Campus** *(expected 2025)*  
- 🌍 **Location**: Sri Lanka  
- 🎯 **Goal**: Lead full-stack projects end-to-end and ship reliable, performant apps  

---

### 💼 Experience (short)
- **Flutter Mobile Developer — VVH Solutions** *(2025–Present)*  
  Feature development across Driver, Client & Merchant apps (Flutter, Firebase, REST, Provider).
- **Research & Developer Intern — Rangiri Holdings** *(2024)*  
  HR Management System & Vehicle Maintenance System (React, Spring Boot, MySQL) with secure, role-based access.
...
### ⭐ Highlights
- 🚕 **WE App** – Multi-app ride & services platform with SSE live tracking & push notifications  
- 🛒 **Foodie Mobile** – Flutter + REST + token auth; clean architecture with Provider  
- 🧑‍💼 **Task Manager (Web)** – Role-based tasks, analytics & export  
...
> Tip: Pin your best repos (Profile → **Customize** → *Pinned*) and add 1280×640 Social Preview banners (repo **Settings → Social preview**).
